        ...
        <div class="container mx-auto px-6">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center">
                    ...
                    <span class="text-white text-xl font-bold">ViajeSeguro</span> --}}
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="flex flex-col md:flex-row items-center gap-12">
                ...
                <div class="md:w-1/2">
                    ...
                    <p class="text-lg mb-6">En ViajeSeguro llevamos más de 15 años brindando soluciones de protección para viajeros en todo el mundo. Nuestra misión es ofrecerte tranquilidad durante tus viajes, con coberturas adaptadas a tus necesidades específicas.</p>
    ...
    {{-- <section id="testimonios" class="py-20 bg-white">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <p class="text-xl max-w-3xl mx-auto mb-6">Experiencias reales de viajeros protegidos por ViajeSeguro</p>
                <div class="w-20 h-1 bg-tertiary mx-auto"></div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="testimonial-card bg-light p-8 rounded-xl">
                    ...
                    <p class="mb-6 italic">"Tuve un accidente en mi viaje a Italia y ViajeSeguro gestionó todo de forma impecable. Desde la atención médica hasta mi repatriación, todo fue perfecto."</p>
                    <div class="flex items-center">
                ...
                <div class="testimonial-card bg-light p-8 rounded-xl">
                    ...
                    <p class="mb-6 italic">"Perdí mi equipaje en un vuelo a París. En menos de 24 horas, ViajeSeguro me proporcionó un adelanto para comprar lo necesario. ¡Servicio excepcional!"</p>
                    <div class="flex items-center">
                        <div class="bg-gray-200 border-2 border-dashed rounded-xl w-16 h-16 mr-4"></div>
                        <div>
                ...
                <div class="testimonial-card bg-light p-8 rounded-xl">
                    ...
                    <p class="mb-6 italic">"Contraté el seguro para mi viaje de estudios a Canadá. La cobertura médica fue fundamental cuando tuve apendicitis. Gracias a ViajeSeguro, todo fue más fácil."</p>
                    <div class="flex items-center">
                        <div class="bg-gray-200 border-2 border-dashed rounded-xl w-16 h-16 mr-4"></div>
                        <div>
                    ...
                    <ul class="glide__slides">
                        ...
                        <li class="glide__slide">
                            <div class="testimonial-card p-8 h-full">
                                ...
                                <p class="mb-8 text-lg italic relative">"Tuve un accidente durante mi viaje a Italia y ViajeSeguro gestionó todo de forma impecable. Desde la atención médica hasta mi repatriación, todo fue perfecto. ¡Increíble servicio en momentos difíciles!"</p>
                                <div class="flex items-center">
                        ...
                        <li class="glide__slide">
                            <div class="testimonial-card p-8 h-full">
                                ...
                                <p class="mb-8 text-lg italic relative">"Perdí mi equipaje en un vuelo a París. En menos de 24 horas, ViajeSeguro me proporcionó un adelanto para comprar lo necesario. ¡Servicio excepcional y muy rápida respuesta en pleno viaje!"</p>
                                <div class="flex items-center">
                                    <div class="bg-light p-3 rounded-lg mr-4">
                        ...
                        <li class="glide__slide">
                            <div class="testimonial-card p-8 h-full">
                                ...
                                <p class="mb-8 text-lg italic relative">"Contraté el seguro para mi viaje de estudios a Canadá. La cobertura médica fue fundamental cuando tuve apendicitis. Gracias a ViajeSeguro, todo fue más fácil y sin preocupaciones económicas."</p>
                                <div class="flex items-center">
                                    <div class="bg-light p-3 rounded-lg mr-4">
