<div>
    <div class="bg-white text-primary rounded-xl shadow-xl p-8 {{ $hiddenFormulario }}">
        <form wire:submit="guardarSolicitud" class="space-y-6">
            ...
            <button wire:click="guardarSolicitud" wire:loading.remove wire:target="guardarSolicitud" type="submit" class="w-full bg-tertiary hover:bg-secondary text-white font-bold py-4 px-6 rounded-lg text-lg transition duration-300">
